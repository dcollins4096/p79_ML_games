...
idd = 4009
what = "4003 with mach_grid suite"
...
dirpath = "./"
fname_train = "p79d_dataset_S256_N1_xyz_down_128_mach_grid_tvs_first.h5"
fname_valid = "p79d_dataset_S256_N1_xyz_down_128_mach_grid_tvs_second.h5"
...
def thisnet():
    ...
    model = main_net(n_scalars=2,base_channels=16,fc_hidden=512 , fc_spatial=8, use_fc_bottleneck=fc_bottleneck, out_channels=3, use_cross_attention=False, attn_heads=1)#, dropout_1=0.3, dropout_2=0.3, dropout_3=0.3)
