...
idd = 50
what = "49 with dropout 0.2, then 0.3, then weight decay 0.1"
...
def train(model,all_data):
    ...
    batch_size=10 
    lr_schedule=[100]
    trainer(model,all_data,epochs=epochs,lr=lr,batch_size=batch_size, weight_decay=0.1, lr_schedule=lr_schedule)
