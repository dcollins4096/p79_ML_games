...
idd = 2
what = "2d conv.  Make one that's just for memorizing.  Works even at 32!"
...
class main_net(nn.Module):
    def __init__(self, in_channels=1, out_channels=2):
        ...
        # Optional: Add batch norm to help learning small datasets
    ...
    def forward(self, x):
        # Encoder
        x = x.unsqueeze(1) #it expects a channel.
        ...
        x = self.conv6(x)  # no activation, raw outputs
