...
idd = 699
what = "184 generic for uniform losses"
...
def criterion1(preds, target):
    ...
    if 1>0:
        ...
        loss_multi = (loss_d2+loss_d3+loss_d4)
    ...
    if 1> 0:
        ...
        lambda_ssim = (ssim_e+ssim_b+ssim_t)/3
    ...
    if 1> 0:
        ...
        lambda_grad = (grad_e+grad_b+grad_t)/3
