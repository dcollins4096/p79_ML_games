...
idd = 60
what = "41 with only positive correlations"
...
def load_data():
    ...
    all_data= loader.loader(fname,ntrain=ntrain, nvalid=nvalid, r_range=[0.1,0.5])
    return all_data

def thisnet():

    model = main_net(base_channels=64, fc_spatial=8, use_fc_bottleneck=False)
