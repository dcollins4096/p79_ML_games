...
idd = 3002
what = "3001 with only yhat"

#fname_train = "p79d_subsets_S256_N5_xyz_down_12823456_first.h5"
#fname_valid = "p79d_subsets_S256_N5_xyz_down_12823456_second.h5"
fname_train = "p79d_subsets_S256_N5_y__down_64fixed_mach_QU_first.h5"
fname_valid = "p79d_subsets_S256_N5_y__down_64fixed_mach_QU_second.h5"
...
class SphericalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return theset[0].to(device), (theset.to(device), torch.tensor([ms,ma], dtype=torch.float32).to(device))
