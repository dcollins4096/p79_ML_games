...
idd = 134
what = "128 with no attention. xhat only"
...
def thisnet():
    ...
    model = main_net(base_channels=32, fc_spatial=4, use_fc_bottleneck=fc_bottleneck, out_channels=3, use_cross_attention=False)
