...
idd = 3108
what = "3105 with more reductions"
...
def thisnet():
    ...
    model = main_net(base_channels=16,fc_hidden=2048 , fc_spatial=4, use_fc_bottleneck=fc_bottleneck, 
                     out_channels=3, use_cross_attention=False, attn_heads=1,
                     dropout_1=0.1, dropout_2=0.9, dropout_3=0.2)
...
def trainer(
    ...
    print("Total Steps", total_steps, "ntrain", ntrain, len(all_data['train']), "epoch", epochs, "nval",nvalid)
