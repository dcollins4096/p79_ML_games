...
class main_net(nn.Module):
    def __init__(self, in_channels=1, out_channels=2, base_channels=32, hidden_dim=512, fc_spatial=4):
        ...
        self.fc1b = nn.Linear(2*hidden_dim, 4*hidden_dim)
        self.fc1c = nn.Linear(4*hidden_dim, 2*hidden_dim)
        self.fc1d = nn.Linear(2*hidden_dim, hidden_dim)
