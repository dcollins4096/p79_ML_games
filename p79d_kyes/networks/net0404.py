...
idd = 404
what = "401 actually add some noise"
...
def trainer(
    ...
    ds_train = SphericalDataset(all_data['train'], rotation_prob=model.rotation_prob, noise=0.1)
    ...
    # restore best
    if best_state is not None and bad_epochs >= patience:
