...
idd = 172
what = "171 but turn on self attention and add capacity"
...
def thisnet():
    ...
    model = main_net(base_channels=64,fc_hidden=1024 , fc_spatial=, use_fc_bottleneck=fc_bottleneck, out_channels=3, use_cross_attention=Tru, attn_heads=1)
